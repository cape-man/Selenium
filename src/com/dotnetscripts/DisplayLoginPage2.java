...
public class DisplayLoginPage2 extends BaseTest
{
	String status="N.A";
...
public void testDisplayLoginPage()
{
	...
	Object[] testdetails=new Object[]{"TD11_dotnetApplication","Display Login Page-2","Login button should be displayed in Login Page",status,(new Date()).getTime(),"3","Login Module-2","SIT","1.4.0",Duration,"Google Chrome","Windows 10","SriHarsha Gadepalli"};
