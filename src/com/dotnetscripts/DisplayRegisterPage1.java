...
public class DisplayRegisterPage1 extends BaseTest
{
	String status="N.A";
...
public void testDisplayRegisterPage()
{
	...
	Object[] testdetails=new Object[]{"TD8_dotnetApplication","Display Register Page-1","Register button should be displayed in Register Page",status,(new Date()).getTime(),"2","Register Module-1","Dev","1.4.0",Duration,"Google Chrome","Windows 10","SriHarsha Gadepalli"};
