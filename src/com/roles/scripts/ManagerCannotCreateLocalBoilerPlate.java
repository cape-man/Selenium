...
public class ManagerCannotCreateLocalBoilerPlate extends BaseTest
{
@Test
public void testManagerCannotCreateLocalBoilerPlate()
{
	System.out.println("******************************ManagerCannotCreateLocalBoilerPlate******************************");
	Reporter.log("******************************ManagerCannotCreateLocalBoilerPlate******************************");
