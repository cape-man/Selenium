...
public class ManagerCannotDeleteLocalBoilerPlate extends BaseTest
{
@Test
public void testManagerCannotDeleteLocalBoilerPlate()
{
	System.out.println("******************************ManagerCannotDeleteLocalBoilerPlate******************************");
	Reporter.log("******************************ManagerCannotDeleteLocalBoilerPlate******************************");
