...
public class ManagerCannotViewActivity extends BaseTest
{
@Test
public void testManagerCannotViewActivity()
{
	System.out.println("******************************ManagerCannotViewActivity******************************");
	Reporter.log("******************************ManagerCannotViewActivity******************************");
