...
public class ManagerCannotCreateCanvas extends BaseTest
{
@Test
public void testManagerCannotCreateCanvas()
{
	System.out.println("******************************ManagerCannotCreateCanvas******************************");
	Reporter.log("******************************ManagerCannotCreateCanvas******************************");
