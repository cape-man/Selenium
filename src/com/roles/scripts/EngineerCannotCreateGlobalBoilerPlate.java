...
public class EngineerCannotCreateGlobalBoilerPlate extends BaseTest
{
@Test
public void testEngineerCannotCreateGlobalBoilerPlate()
{
	System.out.println("******************************EngineerCannotCreateGlobalBoilerPlate******************************");
	Reporter.log("******************************EngineerCannotCreateGlobalBoilerPlate******************************");
